ServerEvents.recipes(event => {
        ...
        if(
            ...
            event.recipes.create.crushing(
                [
                    ...
                    Item.of('gtceu:crushed_' + itemIds.slice(10) + '_ore').withChance(0.2),
    ...
    crushedore.forEach( (itemIds) => {
        event.recipes.create.crushing(
            [
                ...
                Item.of('gtceu:impure_' + itemIds.slice(14, -4) + '_dust').withChance(0.1)
            ],
            itemIds
        )
    })
	...
	//ingot crushing
	//ingots.forEach((itemIds)=>{
	//	events.recipes.create.crushing(itemIds.slice())
	//})
